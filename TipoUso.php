...
<HTML>
  ...
  <BODY>
    ...
    echo '<a class="linkInserirNovo" href="tipoUsoInsert.php">Inserir Novo Tipo de Uso do Telefone</a>';
    echo('<br><br>');
    ...
    while ($dados = mysql_fetch_array($consulta))
    {
      // print_r($dados);
    	echo "<tr>";
    		...
    		echo '<td><a href=tipoUsoEdit.php?TP_Uso=' . $dados[TP_Uso] . '>Alterar</a></td>';
    		echo '<td><a href=tipoUsoDelete.php?TP_Uso=' . $dados[TP_Uso] .
