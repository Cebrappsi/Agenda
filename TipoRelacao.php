...
<HTML>
  ...
  <BODY>
    ...
    echo '<a class="linkInserirNovo" href="tipoRelacaoInsert.php">Inserir Novo Tipo de Relacionamento</a>';
    echo('<br><br>');
    ...
    while ($dados = mysql_fetch_array($consulta))
    {
      // print_r($dados);
    	echo "<tr>";
    		...
    		echo '<td><a href=tipoRelacaoEdit.php?TP_Relacao=' . $dados[TP_Relacao] . '>Alterar</a></td>';
    		echo '<td><a href=tipoRelacaoDelete.php?TP_Relacao=' . $dados[TP_Relacao] .
