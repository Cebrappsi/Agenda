  ...
  <BODY>
    <form method="post" action="tipoEmailDelete.php">
    	<fieldset>
    		...
    		<label class="Labelconfirma">Confirma Exclusão de Tipo de Email? (S/N) :</label>
    		<?php
...
*/
    ...
    if (!$Objtipo_Email->Delete($MsgErro))
       //MsgPopup('Erro na ExclusÃ£o do Registro : ' . $Objtipo_Email->MsgErro);
        echo '<br><a class="MsgErro">Erro na Exclusão do Registro : ' . $Objtipo_Email->MsgErro .'</a>';
    else 
